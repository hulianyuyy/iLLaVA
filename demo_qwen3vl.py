...
def parse_args():
    ...
    # Params for iLLaVA
    # Params for iLLaVA
    parser.add_argument("--enable_illava_vit", type=bool, default=True)
    parser.add_argument("--illava_vit_k", type=str, default='5-6-7-8')   # Input with format like '2-3' denoting layers 2 and 3
    parser.add_argument("--illava_vit_r", type=float, default=0.90)
    parser.add_argument("--enable_illava_llm", type=bool, default=True)
    parser.add_argument("--illava_llm_k", type=str, default='15-17-19-21')   # Input with format like '2-3' denoting layers 2 and 3
    parser.add_argument("--illava_llm_r", type=float, default=0.85)
...
if __name__ == "__main__":
    ...
    model = AutoModelForImageTextToText.from_pretrained(
                model_path, dtype="auto", device_map="auto", attn_implementation='flash_attention_2', illava_config=illava_config, 
            )
