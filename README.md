...
The detailed args of iLLaVA for Qwen3-VL are defined in line 1274 of [config.py](https://github.com/hulianyuyy/iLLaVA/blob/main/VLMEvalKit/vlmeval/config.py#L1274)
